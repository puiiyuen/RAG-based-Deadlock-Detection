 ...
 * write matrix.txt
 * param: i: row index, j: column index, signal: content to write
 */
...
/*
 * function: train
 * trains pass the junction
 * param: id: train id , dir: direction of the train, lock: set of semaphore
 */

void train(int id, int dir, semLock *&lock) {

    //set direction for print out
...
/*
 * Function: close the connection of named semaphore
 * param: sLock: set of semaphore
 * return: true: Successfully close
 */
